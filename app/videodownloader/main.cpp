...
int main(int argc, char *argv[])
{
    ...
    CreateMutex(NULL, FALSE, L"4KVIDEODOWNLOADER");

#endif

    // Prevent multiple execution

    ComponentModel::SingleApplication a(argc, argv, "4KVIDEODOWNLOADER");
    ...
    factory->add(ViewModel::DownloadSettingsViewModel::staticMetaObject, View::DownloadSettingsView::staticMetaObject);
    factory->add(ViewModel::SmartModeViewModel::staticMetaObject, View::SmartModeView::staticMetaObject);
