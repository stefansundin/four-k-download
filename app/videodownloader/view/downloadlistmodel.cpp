...
QVariant DownloadListModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::DecorationRole:
        return m_viewModel.data()->at(index.row()).staticCast<DownloadItemViewModel>()->thumbnail();
    ...
    case FormatRole:
        return m_viewModel.data()->at(index.row()).staticCast<DownloadItemViewModel>()->format();
    ...
    case MediaRole:
        return QVariant::fromValue(m_viewModel.data()->at(index.row()).staticCast<DownloadItemViewModel>()->media());
